...
#define PIN_ROTDIN_AX 5            // PD5: inverted output direction; may be commented
#define PIN_LOWSPD_AX -1 // 0      // PD0: output speed (low/high); may be commented
...
#define PIN_ROTDIN_EY 8            // PB0: inverted output direction; may be commented
#define PIN_LOWSPD_EY -1 // 1      // PD1: output speed (low/high); may be commented
...
#define MINSPEED 80                // min. speed (% of max. voltage)
...
#define SPD_ENDSW1 100             // speed1 cal. to endswitch
#define SPD_ENDSW2 0               // speed2 cal. to endswitch (0: single-calibration)
